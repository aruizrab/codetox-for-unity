...
namespace Codetox.Editor.GameEvents
{
    ...
    {
        [MenuItem(Framework.MenuRoot.GameEvents.Void, priority = -100)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.Bool, priority = -9)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.Float, priority = -8)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.Int, priority = -7)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.String, priority = -6)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.Vector2, priority = -5)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.Vector3, priority = -4)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.GameObject, priority = 10)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.Component, priority = 11)]
        ...
        [MenuItem(Framework.MenuRoot.GameEvents.Reference, priority = 12)]
