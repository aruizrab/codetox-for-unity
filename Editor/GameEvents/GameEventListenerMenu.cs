...
namespace Codetox.Editor.GameEvents
{
    public static class GameEventListenerMenu
    {
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Void, priority = -100)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Bool, priority = -9)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Float, priority = -8)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Int, priority = -7)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.String, priority = -6)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Vector2, priority = -5)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Vector3, priority = -4)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.GameObject, priority = 10)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Component, priority = 11)]
        ...
        [MenuItem("Tools/" + Framework.MenuRoot.GameEventListeners.Reference, priority = 12)]
