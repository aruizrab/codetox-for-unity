...
namespace Codetox.Editor.Variables
{
    ...
    {
        [MenuItem(Framework.MenuRoot.Variables.Bool, priority = -9)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.Float, priority = -8)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.Int, priority = -7)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.String, priority = -6)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.Vector2, priority = -5)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.Vector3, priority = -4)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.GameObject, priority = 10)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.Component, priority = 11)]
        ...
        [MenuItem(Framework.MenuRoot.Variables.Reference, priority = 12)]
