...
namespace Codetox.Editor.Input
{
    ...
    {
        [MenuItem(Framework.MenuRoot.Input.ActionHandlers.Void, priority = -20)]
        ...
        [MenuItem(Framework.MenuRoot.Input.ActionHandlers.Bool)]
        ...
        [MenuItem(Framework.MenuRoot.Input.ActionHandlers.Float)]
        ...
        [MenuItem(Framework.MenuRoot.Input.ActionHandlers.Vector2)]
        ...
        [MenuItem(Framework.MenuRoot.Input.ActionHandlers.Vector3)]
